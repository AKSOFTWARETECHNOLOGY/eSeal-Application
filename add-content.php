			...
			<div role="main" class="main">
				...
				<section class="section section-primary pt-md pb-md mt-none">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<h2 class="mb-none">Add Content</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="heading heading-border heading-middle-border">
								<h2>Add <strong>Content</strong></h2>
								<div class="" style="float:right;"> View Contents <a href="dashboard.php#content">BACK</a> </div>
							</div>
                            ...
                            <div class="row">
								...
								<div class="panel-body">
									<form class="form-horizontal form-bordered" method="post" action="doadd-content.php" enctype="multipart/form-data">
									
										<div class="form-group">
											<label class="col-md-3 control-label" for="contentTitle">Content Title</label>
											<div class="col-md-6">
										...
										<div class="form-group">
											<label class="col-md-3 control-label" for="contentInfo">Content Information</label>
											<div class="col-md-6">
												<textarea class="form-control" id="contentInfo" name="content_info" required></textarea>
											</div>
										</div>										
									
										<div class="form-group">
											<label class="col-md-3 control-label" for="contentPhoto">Content Photo</label>
											<div class="col-md-6">
												<input type="file" class="form-control" id="contentPhoto" name="content_photo" accept="image/*"/>
											</div>
										</div>
										 
										<div class="form-group">
											<label class="col-md-3 control-label" for="contentLanguage">Content Language</label>
											<div class="col-md-6">
												<select class="form-control" id="contentLanguage" name="content_language" required >
										...
										<div class="form-group">
											<label class="col-md-3 control-label" for="contentGenre">Content Genre</label>
											<div class="col-md-6">
												<select class="form-control" id="contentGenre" name="content_genre" required >
										...
										<div class="form-group">
											<label class="col-md-3 control-label" for="conteneAttach">Content Attachment</label>
											<div class="col-md-6">
												<input type="file" class="form-control" id="conteneAttach" name="content_attach" accept="application/pdf,application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint,
text/plain, application/pdf, image/*" required />
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<button type="submit" name="addcontent" class="btn btn-success mr-xs mb-sm">Add Content</button>
											</div>
										</div>
									</form>
								</div>
