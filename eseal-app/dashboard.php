...
WHERE products.product_status='1' AND `product_order`.`product_sale_status`=1 AND product_order.product_exporter_id='$user_id'";
...
LEFT JOIN `products` ON products.id = product_order.product_id
WHERE products.product_status='1' AND product_order.product_order_status=0 AND `product_order`.`product_sale_status`=1 AND product_order.product_exporter_id='$user_id'";
...
LEFT JOIN `products` ON products.id = product_order.product_id
WHERE products.product_status='1' AND product_order.product_order_status=1 AND `product_order`.`product_sale_status`=1 AND product_order.product_exporter_id='$user_id'";
...
LEFT JOIN `products` ON products.id = product_order.product_id
WHERE products.product_status='1' AND product_order.product_order_status=2 AND `product_order`.`product_sale_status`=1 AND product_order.product_exporter_id='$user_id'";
...
LEFT JOIN `products` ON products.id = product_order.product_id
WHERE products.product_status='1' AND product_order.product_order_status=3 AND `product_order`.`product_sale_status`=1 AND product_order.product_exporter_id='$user_id'";
...
LEFT JOIN `products` ON products.id = product_order.product_id
WHERE products.product_status='1' AND product_order.product_order_status=4 AND `product_order`.`product_sale_status`=1 AND product_order.product_exporter_id='$user_id'";
