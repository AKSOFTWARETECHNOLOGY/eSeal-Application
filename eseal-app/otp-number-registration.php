...
<p class="text-center"><b>OTP sent to your registered mobile number please enter it below.</b></p>
<div class="reg-otp">
<form action="user-registration.php" method="post">
<div class="form-group">
<input type="text" name="text" placeholder="OTP" class="otp-input">
<div class="otp-form">
<input type="submit" value="Submit" name="otp" class="otp-submit">
</div>
<div class="go-back">
<ul>
<li><a href="otp-registration.php">Go Back</a></li>
<li><a href="otp-registration.php">Resend OTP</a></li>
</ul>
</div>
</div>
 </form>
