...
VALUES ('$user_id','$exporterName','$personName','$address','$cityId','$state','$countryId','$pincode','$telephone','$mobile','$email','$gstin','$panNumber','$AadhaarNumber', '$icecode','$username','$username','$date','$date')";
                ...
                $insert_address_sq1 = "INSERT INTO `exporter_address` (user_id, name, address, city, state, country, pincode,  mobile, gst, created_by, updated_by, created_at, updated_at)
VALUES ('$user_id','$personName','$address','$cityId','$state','$countryId','$pincode','$mobile','$gstin','$username','$username','$date','$date')";
