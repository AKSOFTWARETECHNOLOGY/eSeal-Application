                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <a href="customslist.php" style="float: right;margin-right: 10px;"><button type="button" class="btn btn-info btn-md" style="margin-bottom:10px;" >Back to Customs List</button></a>
                                        <a href="customsedit.php?customs_id=<?php echo $custom_fet['id']; ?>" style="float: right;margin-right: 10px;"><button type="button" class="btn btn-warning btn-md" style="margin-bottom:10px;"><i class="fa fa-pencil"></i> Edit</button></a>
                                        <?php
                                        if($custom_fet['delete_status'] == 1){
                                            ?>
                                            <a href="customs-delete.php?delete=1&customs_id=<?php echo $custom_fet['user_id']; ?>" style="float: right;margin-right: 10px;" onclick="return confirm('Are you sure you want to disable this item?');"><button type="button" class="btn btn-danger btn-md"><i class="fa fa-trash-o"></i> Disable</button></a>
                                        <?php
                                        }
                                        else{
                                            ?>
                                            <a href="customs-delete.php?enable=1&customs_id=<?php echo $custom_fet['user_id']; ?>" style="float: right;margin-right: 10px;" onclick="return confirm('Are you sure you want to enable this item?');"><button type="button" class="btn btn-success btn-md"><i class="ion ion-pie-graph"></i> Enable</button></a>
                                        <?php
                                        }
                                        ?>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group col-md-12">
                                            <label class="col-sm-5 control-label">Customs Code</label>
                                            <div class="col-sm-7"><div class=""> <?php echo $custom_fet['customs_code']; ?></div></div>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label class="col-sm-5 control-label">Customs Name</label>
                                            <div class="col-sm-7"><div class=""><?php echo $custom_fet['name_customs']; ?></div></div>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label class="col-sm-5 control-label">Address</label>
                                            <div class="col-sm-7"><div class=""> <?php echo $custom_fet['address']; ?></div></div>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label class="col-sm-5 control-label">City</label>
                                            <div class="col-sm-7"><div class=""><?php echo $custom_fet['city_name']; ?></div></div>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label class="col-sm-5 control-label">State</label>
                                            <div class="col-sm-7"><div class="" ><?php echo $custom_fet['state_name']; ?></div></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="col-sm-7"><div class=""> <?php echo $custom_fet['country_name']; ?></div></div>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label class="col-sm-5 control-label">Pincode</label>
                                            <div class="col-sm-7"><div class=""> <?php echo $custom_fet['pincode']; ?></div></div>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label class="col-sm-5 control-label">Telephone</label>
                                            <div class="col-sm-7"><div class="" ><?php echo $custom_fet['telephone']; ?></div></div>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label class="col-sm-5 control-label">Mobile</label>
                                            <div class="col-sm-7"><div class=""> <?php echo $custom_fet['mobile']; ?></div></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="col-sm-7"><div class=""><?php echo $custom_fet['email']; ?></div></div>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label class="col-sm-5 control-label">Port</label>
                                            <div class="col-sm-7"><div class=""> <?php echo $custom_fet['ports_name']; ?></div></div>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label class="col-sm-5 control-label">Terminal</label>
                                            <div class="col-sm-7"><div class=""><?php echo $custom_fet['terminals_name']; ?></div></div>
                                        </div>
                                        <div class="form-group col-md-12">
