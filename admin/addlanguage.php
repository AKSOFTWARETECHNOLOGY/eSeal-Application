          ...
          <div class="row">
            ...
            <div class="col-md-9">
              ...
              <div class="box box-primary">
				...
				<?php if(isset($_REQUEST['err'])) { ?> <span style="color:red;font-size:16px;font-weight:bold;"> Record Not Added </span> <?php } ?>
									...
									<form class="form-horizontal form-bordered" method="post" action="doaddlanguage.php" enctype="multipart/form-data">
									
										<div class="form-group">
											<label class="col-md-3 control-label" for="languageName">Language Name</label>
											<div class="col-md-6">
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<button type="submit" name="addlanguage" class="btn btn-success mr-xs mb-sm">Add Language</button>
											</div>
										</div>
									</form>
            ...
            <div class="col-md-3">
              ...
              <div class="box box-danger" >
                <div class="box-header with-border">
                  <h3 class="box-title">Manage Language Profile</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                
                  <div class="box-body">
                    <div class="form-group col-md-12">
                       <a href="languagelist.php"><button type="submit" class="btn btn-info col-md-12" style="margin-bottom:10px;" >Back to Languages List</button></a>
