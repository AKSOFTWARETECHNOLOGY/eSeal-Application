			...
			<div role="main" class="main">
				...
				<section class="section section-primary mt-none">
					<div class="container">
						<div class="row">
							<div class="col-sm-12">
								<h1><strong>Register/Login </strong>to explore more.</h1>
								<p class="lead">Only registered users can view the content uploaded by the Authors. Please Register/Login here.</p>
                        ...
                        <div class="col-sm-12">
                            <h2>Login</h2>
								...
								<?php } ?>
									...
									<form class="form-horizontal form-bordered" method="post" action="dologin.php">
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<button type="submit" name="login" class="btn btn-success mr-xs mb-sm">Login</button>
												<p>Not a Member! <a href="register.php">Register here.</a> Its 100% free.</p>
												<p>Forgot Login Details! <a href="forgot-login.php">Reset Password.</a> </p>
											</div>
										</div>
									</form>
								</div>
