...
$content_info_sql="SELECT * FROM `writer_content` WHERE `id`='$content_id'";
...
<html>
	<head>
		...
		<title>NextPUB | Content Details</title>	
			...
			<div role="main" class="main">
				...
				<section class="section section-primary pt-md pb-md mt-none">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<h2 class="mb-none">Content Details</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                             ...
                             <div class="heading heading-border heading-middle-border">
								<h2>View <strong>Content</strong></h2>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="row mb-xl">
                                        ...
                                        <?php echo $content_info['created_at']; ?>                                        
                                        </div><!-- 1/3 col ends-->
									...
									<?php if(isset($_SESSION['nextpubuserid'])){ ?>
                                        ...
                                        <?php echo $content_userinfo['email']; ?>                                        
                                        </div><!-- 1/3 col ends-->
                                        ...
                                        <?php echo $content_userinfo['telephone']; ?>                                        
                                        </div><!-- 1/3 col ends-->
