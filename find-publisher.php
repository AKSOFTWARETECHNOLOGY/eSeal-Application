...
$user_info_sql="SELECT u.id, u.confirmed, u.`delete_status`, p.* FROM `users` u INNER JOIN `publisher` p ON u.`id` = p.`user_id` AND u.`id` != 1 AND u.`confirmed`=1  AND u.`delete_status`=0";
...
<html>
	<head>
		...
		<title>NextPUB | Publisher Listing</title>	
		...
		<div class="body">
			...
			<div role="main" class="main">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
                                <h2 class="mb-md">Listings <strong>Publishers</strong></h2>
								<p class="lead">Search results and listings publisher.</p>
                ...
                <div class="container">
                    <h2 class="center">Publishers listing</h2>
                <div class="row mb-xl">
