...
<html>
	<head>
		...
		<title>NextPUB |Register Completed Successfully</title>	
			...
			<div role="main" class="main">
				...
				<section class="section section-primary">
					<div class="container">
						<div class="row">
							<div class="col-sm-12">
								<h1><strong>Register </strong>Completed Successfully.</h1>
				...
				<div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <h2>Register Completed Successfully</h2>
							
							<div> You have registered and the activation mail is sent to your email. Click the activation link to activate you account </div>
							<div> Click Here For <a href="login.php">Login</a></div>
