...
<html>
	<head>
		...
		<title>NextPUB | Publisher Details</title>	
			...
			<div role="main" class="main">
				...
				<section class="section section-primary pt-md pb-md mt-none">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<h2 class="mb-none">Publisher Details</h2>
							</div>
						</div>
					</div>
				</section>
				...
				<div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
							...
							<h2>Publisher <strong>Info</strong></h2>
							</div>
							...
							<!-- languages starts-->
                             ...
                             <div id="language" class="heading heading-border heading-middle-border">
								<h2>Publisher <strong>Languages</strong></h2>
							</div>
                            ...
                            <div id="genre" class="heading heading-border heading-middle-border">
								<h2>Publisher <strong>Genre</strong></h2>
							</div>
							...
							<div id="book" class="heading heading-border heading-middle-border">
								<br /><br /><br /><br /><br /><br />
								<h2>Publisher <strong>Book</strong></h2>								
							</div>
							...
							<div id="requirement" class="heading heading-border heading-middle-border">
								<br /><br /><br /><br /><br /><br />
								<h2>Publisher <strong>Requirement</strong></h2>								
							</div>
