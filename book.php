...
$book_info_sql="SELECT * FROM `publisher_book` WHERE `id`='$book_id'";
...
<html>
	<head>
		...
		<title>NextPUB | Book Details</title>	
			...
			<div role="main" class="main">
				...
				<section class="section section-primary pt-md pb-md mt-none">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<h2 class="mb-none">Book Details</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                             ...
                             <div class="heading heading-border heading-middle-border">
								<h2>View <strong>Book</strong></h2>
								<div class="" style="float:right;"> List Book <a href="javascript: window.history.go(-1)">BACK</a> </div>
							</div>
