...
$publisher_book_sql="SELECT * FROM `publisher_book_requirement` WHERE `id`='$book_id'";
	...
	<?php include "header.php"; ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            View Publisher Requirement Details
           
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
           
            <li class="active">View Publisher Requirement Details</li>
          </ol>
        </section>
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">View Publisher Requirement Details</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form">
                  <div class="box-body">
            ...
            <div class="col-md-3">
              ...
              <div class="box box-danger" >
                <div class="box-header with-border">
                  <h3 class="box-title">Publisher Requirement Profile</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                
                  <div class="box-body">
                    <div class="form-group col-md-12">
                       <a href="requirementlist.php"><button type="submit" class="btn btn-info col-md-12" style="margin-bottom:10px;" >Back to Requirements List</button></a>
					   
					   
					   <?php if($publisher_book_fet['book_status']==0) { ?>
					   <a href="dorequirementupdate.php?update=1&book_id=<?php echo $publisher_book_fet['id']; ?>&user_id=<?php echo $publisher_book_fet['user_id']; ?>">
					   <button type="button" class="btn btn-success col-md-12" style="margin-bottom:10px;">Approve Requirement</button>
					   </a>
					   
					   <a href="dorequirementupdate.php?update=2&book_id=<?php echo $publisher_book_fet['id']; ?>&user_id=<?php echo $publisher_book_fet['user_id']; ?>">
					   <button type="button" class="btn btn-danger col-md-12" style="margin-bottom:10px;">Reject Requirement</button>
					   </a>
					   <?php } else if($publisher_book_fet['book_status']==1){ ?>
					   <a href="dorequirementupdate.php?update=0&book_id=<?php echo $publisher_book_fet['id']; ?>&user_id=<?php echo $publisher_book_fet['user_id']; ?>">
					   <button type="button" class="btn btn-warning col-md-12" style="margin-bottom:10px;">Pending Requirement</button>
					   </a>
