                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group col-md-2">
                        <a href="dashboard.php">
                            <button type="submit" class="btn btn-warning col-md-12" style="margin-bottom:10px;" >Back to Search</button>
                        </a>
                    </div>
                </div><!--/.col (right) -->
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="col-sm-6"><div class=""> <?php echo $order_fet['product_unicode']; ?></div></div>
                                    </div>
                                    <div class="form-group col-md-4">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label class="col-sm-6 control-label">Shipping Bill No</label>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="col-sm-6"><div class=""> <?php echo $order_fet['destination_port']; ?></div></div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="col-sm-6 control-label">Terminal Name</label>
                                        <div class="col-sm-6"><div class=""><?php echo $order_fet['terminal_name']; ?></div></div>
                                    </div>
                                    <div class="form-group col-md-4">
                                    ...
                                    <fieldset class="form-group col-md-12">
                                        ...
                                        <?php if($order_fet['customs_approve_status'] == 1){ ?>
                                            <div class="form-group col-md-4">
                                                <label class="col-sm-6 control-label"> E-Seal Status</label>
                                                <div class="col-sm-6"><div class=""> Success </div></div>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label class="col-sm-6 control-label"> Approved Date</label>
                                                <div class="col-sm-6"><div class=""> <?php echo $order_fet['customs_approve_date']; ?></div></div>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label class="col-sm-6 control-label"> Approved Time</label>
                                                <div class="col-sm-6"><div class="" ><?php echo $order_fet['customs_approve_time'] ?></div></div>
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label class="col-sm-3 control-label"> Approved Note</label>
                                                <div class="col-sm-9"><div class=""> <?php echo $order_fet['customs_approve_note']; ?></div></div>
                                            </div>
                                        <?php } else if($order_fet['customs_approve_status'] == 2){ ?>
                                            <div class="form-group col-md-4">
                                                <label class="col-sm-6 control-label"> E-Seal Status</label>
                                                <div class="col-sm-6"><div class=""> Tampered </div></div>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label class="col-sm-6 control-label"> Tampered Date</label>
                                                <div class="col-sm-6"><div class=""> <?php echo $order_fet['customs_approve_date']; ?></div></div>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label class="col-sm-6 control-label"> Tampered Time</label>
                                                <div class="col-sm-6"><div class="" ><?php echo $order_fet['customs_approve_time'] ?></div></div>
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label class="col-sm-3 control-label"> Tampered Note</label>
                                                <div class="col-sm-9"><div class=""> <?php echo $order_fet['customs_approve_note']; ?></div></div>
                                            </div>
                                        <?php
                                        }
                                        ...
                                        ?>
                                            <div class="form-group col-md-12">
                                                <label class="col-sm-12 control-label">Waiting for the Customs Approval Process</label>
                                            </div>
                                        <?php
                                        }
                                        ?>
