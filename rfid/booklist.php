      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Publisher Books List</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title" style="line-height:30px;">Publisher Books List</h3>
				  <a href="addbook.php">
				...
				?>
				  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tr>
                      ...
                      <td>
                      	 <a href="bookview.php?book_id=<?php echo $publisher_book_fet['id']; ?>&user_id=<?php echo $publisher_book_fet['user_id']; ?>">
						 ...
						 &nbsp;&nbsp;&nbsp;
                      	 <a href="delete-book.php?delete=1&id=<?php echo $publisher_book_fet['id']; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><button type="button" class="btn btn-warning btn-xs"><i class="fa fa-trash-o"></i> Delete</button></a>
                       </td>
                    </tr>
					<?php
					}
