	...
	<?php include "header.php"; ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Writer Contents List
           
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
           
            <li class="active">Writer Contents List</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title" style="line-height:30px;">Writer Contents List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
				...
				?>
				  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
					<?php 
					while($writer_content_fet=mysql_fetch_array($writer_content_exe))
					{
					?>
                    <tr>
                      <td><?php echo $writer_content_fet['id']; ?></td>
                      <td><?php echo $writer_content_fet['content_title']; ?></td>
                      <td><?php echo $content_language[$writer_content_fet['content_language']]; ?></td>
					  <td><?php echo $content_genre[$writer_content_fet['content_genre']]; ?></td>

						<td>
					  <?php if($writer_content_fet['content_status']==0) { ?><span class="label label-warning">Pending</span><?php } ?>
					  <?php if($writer_content_fet['content_status']==1) { ?><span class="label label-success">Active</span><?php } ?>
					  <?php if($writer_content_fet['content_status']==2) { ?><span class="label label-danger">Rejected</span><?php } ?>
					  </td>
              
                      <td>
                      	 <a href="contentview.php?content_id=<?php echo $writer_content_fet['id']; ?>&user_id=<?php echo $writer_content_fet['user_id']; ?>">
						 ...
						 &nbsp;&nbsp;&nbsp;
                      	 <a href="delete-content.php?delete=1&id=<?php echo $writer_content_fet['id']; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><button type="button" class="btn btn-warning btn-xs"><i class="fa fa-trash-o"></i> Delete</button></a>
                       </td>
                    </tr>
					<?php
					}
