...
$content_info_sql="SELECT * FROM `writer_content` WHERE `user_id`='$user_id' AND `id`='$content_id'";
$content_info_exe=mysql_query($content_info_sql);
$content_info=mysql_fetch_array($content_info_exe);
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="col-md-3">
											...
											<a href="delete-content.php?id=<?php echo $content_info['id']; ?>&delete=1" class="btn btn-md btn-secondary" onclick="return confirm('Are you sure ?')">DELETE CONTENT</a>
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="row mb-xl">
                                        ...
                                        <?php echo $content_info['content_title']; ?>
                                        </div>
                                        ...
                                        <?php //echo $content_info['content_language']; ?>                                        
										<?php echo $content_language[$content_info['content_language']]; ?>
                                        </div><!-- 1/3 col ends-->
                                        ...
                                        <?php //echo $content_info['content_genre']; ?>
										<?php echo $content_genre[$content_info['content_genre']]; ?>                                        
                                        </div><!-- 1/3 col ends-->
										...
										<?php if($content_info['content_attach']!="") { ?>
											<a href="<?php echo $content_info['content_attach']; ?>" alt="" target="_blank"> DOWNLOAD </a>
										<?php } else { ?>
											None
										<?php } ?>
										</div>
										...
										<?php
										$content_user_id=$content_info['user_id'];
										$content_userinfo_sql="SELECT * FROM `writer` WHERE `user_id`='$content_user_id'";
										$content_userinfo_exe=mysql_query($content_userinfo_sql);	
										$content_userinfo=mysql_fetch_array($content_userinfo_exe);
										?>
                                        <?php echo $content_userinfo['name']; ?>                                        
                                        </div><!-- 1/3 col ends-->
                                     ...
                                     <div class="row mb-xl">
                                        ...
                                        <?php echo $content_info['content_info']; ?>                                        
                                        </div>
                                    </div>
