...
$book_info_sql="SELECT * FROM `publisher_book_requirement` WHERE `id`='$book_id'";
...
<html>
	<head>
		...
		<title>NextPUB | Requirement Details</title>	
			...
			<div role="main" class="main">
				...
				<section class="section section-primary pt-md pb-md mt-none">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<h2 class="mb-none">Requirement Details</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                             ...
                             <div class="heading heading-border heading-middle-border">
								<h2>View <strong>Requirement</strong></h2>
								<div class="" style="float:right;"> List Requirement <a href="javascript: window.history.go(-1)">BACK</a> </div>
							</div>
                            ...
                            <div class="row">
											...
											<a href="#">
												<span class="thumb-info">
													<span class="thumb-info-wrapper">
														...
														<?php } else { ?>
															<img src="img/np/book.gif" class="img-responsive" alt="">
														<?php } ?>
                                ...
                                <div class="col-md-9">
									...
									<?php if(isset($_SESSION['nextpubuserid'])){ ?>
                                        ...
                                        <?php echo $book_userinfo['telephone']; ?>                                        
                                        </div><!-- 1/3 col ends-->
                                    
									<?php } else { ?>
									<div class="col-md-12">
                                        <div class="">
											<h4>To View Publisher Contact Details</h4>
											<div class="col-md-3">
