...
$content_info_sql="SELECT * FROM `writer_content`";
...
<html>
	<head>
		...
		<title>NextPUB | Find A Service</title>	
		...
		<div class="body">
			...
			<div role="main" class="main">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
                                <h2 class="mb-md">Listings <strong>Page</strong></h2>
								<p class="lead">Search results and listings page.</p>
