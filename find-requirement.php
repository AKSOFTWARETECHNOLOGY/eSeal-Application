...
$content_info_sql="SELECT * FROM `publisher_book_requirement` WHERE `book_status`='1' AND `user_id`>0 $keyword_filter $genre_filter $language_filter";
...
{
$content_info_sql="SELECT * FROM `publisher_book_requirement` WHERE `book_status`='1'";
$content_info_exe=mysql_query($content_info_sql);
$content_info_num=@mysql_num_rows($content_info_exe);
}
...
<html>
	<head>
		...
		<title>NextPUB | Requirement Listing</title>	
		...
		<div class="body">
			...
			<div role="main" class="main">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
                                <h2 class="mb-md">Listings <strong>Requirements</strong></h2>
								<p class="lead">Search results and listings requirement.</p>
							</div>
						</div>
					</div>
				</section>
                ...
                <?php include "requirement-filter.php"; ?>
                <!-- search filter ends-->
                ...
                <div class="container">
                    <h2 class="center">Requirement listing</h2>
                <div class="row mb-xl">
