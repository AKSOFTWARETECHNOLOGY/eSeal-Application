...
$book_info_sql="SELECT * FROM `publisher_book` WHERE `user_id`='$user_id' AND `id`='$book_id'";
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="col-md-3">
											...
											<a href="delete-book.php?id=<?php echo $book_info['id']; ?>&delete=1" class="btn btn-md btn-secondary" onclick="return confirm('Are you sure ?')">DELETE BOOK</a>
