			...
			<div role="main" class="main">
				...
				<section class="section section-primary pt-md pb-md mt-none">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<h2 class="mb-none">Add Book Requirement</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="heading heading-border heading-middle-border">
								<h2>Add <strong>Requirement</strong></h2>
                            ...
                            <div class="row">
								...
								<div class="panel-body">
									<form class="form-horizontal form-bordered" method="post" action="doadd-book-requirement.php" enctype="multipart/form-data">
									
										<div class="form-group">
											<label class="col-md-3 control-label" for="bookTitle">Requirement Title</label>
											<div class="col-md-6">
										...
										<div class="form-group">
											<label class="col-md-3 control-label" for="bookInfo">Requirement Information</label>
											<div class="col-md-6">
										...
										<div class="form-group">
											<label class="col-md-3 control-label" for="bookPhoto">Requirement Photo</label>
											<div class="col-md-6">
										...
										<div class="form-group">
											<label class="col-md-3 control-label" for="bookLanguage">Requirement Language</label>
											<div class="col-md-6">
										...
										<div class="form-group">
											<label class="col-md-3 control-label" for="bookGenre">Requirement Genre</label>
											<div class="col-md-6">
										...
										<div class="form-group">
											<label class="col-md-3 control-label" for="bookPhoto">Requirement Attachment</label>
											<div class="col-md-6">
...
text/plain, application/pdf, image/*" required />
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<button type="submit" name="addbook" class="btn btn-success mr-xs mb-sm">Add Requirement</button>
											</div>
										</div>
									</form>
								</div>
